...
const EditingStudentSchema = new mongoose.Schema({
...
const EditingStudent = mongoose.model('EditingStudent', EditingStudentSchema);
export default EditingStudent; // Export as the default export