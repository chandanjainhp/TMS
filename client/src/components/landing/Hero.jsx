    ...
    <div className="relative bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto lg:flex lg:items-center lg:justify-between">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block">Teacher Student</span>
                <span className="block text-indigo-600">Management System</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Streamline your educational institution's workflow with our comprehensive solution.
              </p>
        ...
        <div className="lg:w-1/2 lg:flex lg:items-center">
          <img 
            className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full lg:max-w-2xl shadow-xl rounded-lg" 
